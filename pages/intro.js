        ...
        <Layout >
            ...
            <div className="p-8 bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <p className="mb-12 text-xl font-normal text-center text-gray-500 dark:text-gray-200">
                    인천 블록체인 칼리지 <br />
                    소상공인 지원 방어형 지식재산권 증빙 서비스
                </p>
                <div className="flex flex-col items-center md:flex-row justify-center evenly">
                    <div className="p-4">
                        <div className="mb-4 text-center opacity-90">
                            <a href="#" className="relative block">
                                <Image alt="profil" src="/images/profile/member_01.png" width="50" height="50" className="mx-auto object-cover rounded-full h-40 w-40 "/>
                            </a>
                        </div>
                    ...
                    <div className="p-4">
                        <div className="mb-4 text-center opacity-90">
                            <a href="#" className="relative block">
                                <Image alt="profil" src="/images/profile/member_02.png" width="50" height="50" className="mx-auto object-cover rounded-full h-40 w-40 "/>
                            </a>
                        </div>
                        <div className="text-center">
                            <p className="text-2xl text-gray-800 dark:text-white">
                    ...
                    <div className="p-4">
                        <div className="mb-4 text-center opacity-90">
                            <a href="#" className="relative block">
                                <Image alt="profil" src="/images/profile/member_03.png" width="50" height="50" className="mx-auto object-cover rounded-full h-40 w-40 "/>
                            </a>
                        </div>
                        <div className="text-center">
                            <p className="text-2xl text-gray-800 dark:text-white">
